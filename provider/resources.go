...
import (
	...
	supabase "github.com/sst/pulumi-supabase/provider/supabase/provider"

	"github.com/sst/pulumi-supabase/provider/pkg/version"
)
...
const (
	...
	mainPkg = "supabase"
	// modules:
	mainMod = "index" // the supabase module
)

//go:embed cmd/pulumi-resource-supabase/bridge-metadata.json
var metadata []byte
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		//
		//    - In provider/cmd/pulumi-tfgen-supabase/main.go, replace the
		...
		//
		//    - In provider/cmd/pulumi-resource-supabase/main.go, replace the
		...
		//
		//      	tfbridge.Main(context.Background(), "supabase", supabase.Provider(),
		...
		// convention is to have a function at "github.com/iwahbe/terraform-provider-supabase/provider".New
		...
		//
		//nolint:lll
		P: pfbridge.ShimProvider(supabase.New(version.Version)()),
		...
		Description:       "A Pulumi package for creating and managing supabase cloud resources.",
		// category/cloud tag helps with categorizing the package in the Pulumi Registry.
		// For all available categories, see `Keywords` in
		// https://www.pulumi.com/docs/guides/pulumi-packages/schema/#package.
		Keywords:   []string{"sst", "supabase", "category/cloud"},
		License:    "Apache-2.0",
		...
		Golang: &tfbridge.GolangInfo{
			ImportBasePath: path.Join(
				"github.com/sst/pulumi-supabase/sdk/",
	...
	prov.MustComputeTokens(tokens.SingleModule("supabase_", mainMod,
